    ...
    <div className="mx-16 pt-6 relative">
      ...
      <nav aria-label="Project navigation" className="mt-4 relative" ref={containerRef}>
        ...
        {isPopupOpen && hiddenTabs.length > 0 && (
          <div
            className="absolute z-10 mt-2 w-48 bg-white border border-gray-200 rounded shadow-lg"
            style={{
              left: moreButtonRef.current?.offsetLeft,
              top: moreButtonRef.current?.offsetTop + moreButtonRef.current?.offsetHeight,
            }}
          >
            <ul className="py-1">
