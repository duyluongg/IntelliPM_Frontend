...
const Register: React.FC = () => {
  ...
  const { data: positionData, isLoading: isPositionsLoading } = useGetCategoriesByGroupQuery('account_position');
  ...
  const errorMessage =
    registerError && 'data' in registerError
      ? (registerError.data as { message?: string })?.message || 'Registration failed! Please try again.'
      : null;
