...
const SidebarPM: FC = () => {
  ...
  return (
    <div className='w-64 h-screen bg-gray-800 text-white flex flex-col shadow-lg'>
      <div className='p-4 text-lg font-bold border-b border-gray-700'>📋 Quản lý Dự án</div>
      ...
      <div className='p-4 border-t border-gray-700 text-sm text-gray-400'>© 2025 YourCompany</div>
    </div>
  );
};
