...
const DateWithIcon = ({ date, status, isDueDate }: { date?: string | null; status: string; isDueDate?: boolean }) => {
  ...
  // Use current date and time dynamically (12:44 AM +07, June 30, 2025)
  const currentDate = new Date('2025-06-30T00:44:00+07:00');
  ...
  if (isDueDate && dueDate) {
    ...
    if (isOverdue && !isDone) {
      ...
      // Due today and not DONE: Specified clock icon
     icon = (
        <svg fill="none" viewBox="0 0 16 16" role="presentation" className="w-4 h-4" style={{ color: '#a84600' }}>
