...
// import FullCalendar from '@fullcalendar/react';
// import dayGridPlugin from '@fullcalendar/daygrid';
// import timeGridPlugin from '@fullcalendar/timegrid'; // 👈 Thêm plugin xem theo tuần
// import interactionPlugin from '@fullcalendar/interaction';
// import type { EventClickArg } from '@fullcalendar/core';
// import { useAuth } from '../../../services/AuthContext';
// import ModalDetailRoom from './Modal/MeetingDetailModal';
...
//   if (eventDay < today) {
//     return '#d1d5db'; // Xám nếu sự kiện nằm trước hôm nay
//   }
...
//     case 'Active':
//     default:
//       return '#3b82f6'; // Xanh dương cho sự kiện sắp tới chưa tham gia
//   }
// };
...
//         <div className="bg-white p-4 rounded-xl shadow-lg">
//           <FullCalendar
//             plugins={[dayGridPlugin, timeGridPlugin, interactionPlugin]} // 👈 Thêm timeGridPlugin
//             initialView="dayGridMonth"
//             headerToolbar={{
//               left: 'prev,next today',
//               center: 'title',
//               right: 'dayGridMonth,timeGridWeek', // 👈 Thêm chế độ xem tuần
//             }}
// events={events.map((ev) => {
