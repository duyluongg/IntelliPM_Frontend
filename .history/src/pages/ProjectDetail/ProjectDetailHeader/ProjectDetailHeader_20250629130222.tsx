...
const ProjectDetailHeader: React.FC = () => {
  ...
  const projectKey = searchParams.get('projectKey') || 'COURSE'; // Mặc định là 'COURSE' nếu không có
  ...
  const projectIconUrl = projectDetails?.data?.iconUrl || 'https://fpt-tuandatcoder.atlassian.net/rest/api/2/universal_avatar/view/type/project/avatar/10410';
