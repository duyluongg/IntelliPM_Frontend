    ...
    <div className="mx-16 pt-6 relative">
      ...
      <nav aria-label="Project navigation" className="mt-4 relative" ref={containerRef}>
        <ul className="flex items-center gap-6 border-b border-gray-200 pb-1">
          ...
          {hiddenTabs.length > 0 && (
            <li className="flex items-center relative" ref={moreButtonRef}>
              <button
                onClick={togglePopup}
        ...
        {isPopupOpen && hiddenTabs.length > 0 && (
          <div
            ...
            style={{
              left: moreButtonRef.current?.offsetLeft ?? 0,
              top: (moreButtonRef.current?.offsetTop ?? 0) + (moreButtonRef.current?.offsetHeight ?? 0),
            }}
          >
            <ul className="py-1">
