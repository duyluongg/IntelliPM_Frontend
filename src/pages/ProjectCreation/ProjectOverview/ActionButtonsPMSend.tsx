...
const ActionButtonsPMSend: React.FC<ActionButtonsProps> = ({ projectKey, projectId, isFormValid, onBack, onNotifyMembers }) => {
  ...
  const handleConfirmAccept = async () => {
    try {
      ...
      await onNotifyMembers(); // Call the onNotifyMembers prop
