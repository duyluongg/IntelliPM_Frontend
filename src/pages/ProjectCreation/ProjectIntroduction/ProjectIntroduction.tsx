...
const ProjectIntroduction: React.FC<ProjectIntroductionProps> = ({ onNext }) => {
  ...
  const ROUTES = {
    PROJECT_CREATE_FORM:
      user?.role === 'PROJECT_MANAGER' ? '/project/pm/createform' : '/project/createform',
    HOME: '/',
  };
    ...
    <div className='bg-white mx-auto rounded-lg shadow min-h-screen pb-32 relative max-w-7xl'>
      ...
      <div className='bg-gradient-to-r from-[#0052CC] to-[#2684FF] p-4 flex justify-between items-center rounded-t-lg text-white'>
        ...
        <div className='flex gap-2 items-center'>
          <button
            onClick={handleNext}
            className='bg-white text-[#0052CC] font-semibold px-4 py-1.5 rounded shadow hover:bg-gray-100 text-sm transition'
      ...
      <div className='grid grid-cols-1 md:grid-cols-[2fr_2fr_1fr] gap-10 p-8'>
        ...
        <div className='md:col-span-2 space-y-10'>
          ...
          <div className='flex items-start gap-6'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-700 mb-2'>
                IntelliPM integrates AI to streamline your project management processes. With
                intelligent automation and smart alerts, your team stays focused and informed.
              </p>
              <ul className='text-sm text-gray-700 list-disc list-inside space-y-1'>
                <li>
                  <strong>Automation:</strong> Auto-generate meeting summaries, progress reports,
                  and task assignments with minimal manual effort.
                </li>
                <li>
                  <strong>Smart alerts:</strong> Instantly detect risks such as delayed deadlines,
                  team overloads, or sprint bottlenecks.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className='grid grid-cols-2 gap-6 items-center'>
            <div>
              ...
              <p className='text-sm text-gray-600 mt-1'>
                Prioritize and plan your team’s work in the backlog. Break tasks into actionable
                items along your project timeline to ensure clarity and alignment.
              </p>
              <a
                href='#'
                className='text-blue-600 text-sm mt-2 inline-block hover:underline'
                aria-label='Learn more about the backlog'
              >
            ...
            <img
              src={backlogImg}
              alt='Backlog planning illustration'
              className='w-41 h-40 object-contain mx-auto'
            />
          </div>
          ...
          <div className='grid grid-cols-2 gap-6 items-center'>
            <img
              src={sprintImg}
              alt='Sprints organization illustration'
            ...
            <div>
              ...
              <p className='text-sm text-gray-600 mt-1'>
                Sprints are short, focused work periods that help teams deliver incremental value.
                Use them to drive continuous delivery, ensure high-quality output, and accelerate
                feedback loops.
              </p>
              <a
                href='#'
                className='text-blue-600 text-sm mt-2 inline-block hover:underline'
                aria-label='Learn more about sprints'
              >
          ...
          <div className='grid grid-cols-2 gap-6 items-center'>
            <div>
              ...
              <p className='text-sm text-gray-600 mt-1'>
                Boost predictability with visual reports like velocity charts and sprint summaries.
                Understand team capacity and continuously improve planning accuracy.
              </p>
              <a
                href='#'
                className='text-blue-600 text-sm mt-2 inline-block hover:underline'
                aria-label='Learn more about agile metrics'
              >
            ...
            <img
              src={velocityImg}
              alt='Team velocity illustration'
              className='w-45 h-44 object-contain mx-auto'
            />
          </div>
        </div>
          ...
          <div>
            ...
            <div className='flex flex-col gap-3 mt-1 text-sm text-gray-700'>
              <div className='flex items-center gap-2'>
                <img src={typeEpic} className='w-4 h-4' alt='Epic icon' /> Epic
              </div>
              <div className='flex items-center gap-2'>
                <img src={typeStory} className='w-4 h-4' alt='Story icon' /> Story
              </div>
              <div className='flex items-center gap-2'>
                <img src={typeBug} className='w-4 h-4' alt='Bug icon' /> Bug
              </div>
              <div className='flex items-center gap-2 text-black'>
                <img src={typeTask} className='w-4 h-4' alt='Task icon' /> Task
              </div>
              <div className='flex items-center gap-2'>
                <img src={typeSubTask} className='w-4 h-4' alt='Sub-task icon' /> Sub-task
              </div>
            </div>
          </div>
          <div>
            ...
            <div className='flex flex-col gap-2 mt-1 text-xs font-medium'>
              <span className='bg-[#DDDEE1] text-gray-800 px-2 py-1 rounded w-fit font-bold'>
                TO DO
              </span>
              <span className='bg-[#87B1E1] text-gray-800 px-2 py-1 rounded w-fit font-bold'>
                IN PROGRESS
              </span>
              <span className='bg-[#B2DA73] text-gray-800 px-2 py-1 rounded w-fit font-bold'>
                DONE
              </span>
            </div>
          </div>
