  ...
  return (
    <header className='w-full flex items-center justify-between p-1 bg-white border-b shadow-sm fixed top-0 left-0 right-0 z-40'>
      <div className='flex items-center space-x-2'>
        ...
        <img src={logo} className='h-10 w-auto object-contain scale-[1.2] ml-3' style={{ transformOrigin: 'left center' }}/>
        <img src={textLogo} className='h-9 w-auto object-contain scale-[0.35] ml-3' style={{ transformOrigin: 'left center' }}/>
      </div>
