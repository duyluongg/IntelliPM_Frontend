...
const Gantt = () => {
  ...
  const allDependencies = projectData?.data?.tasks.flatMap((task) => task.dependencies) || [];
  ...
  const buildDataSource = () => {
    ...
    //           progress: calcAverageProgress(unscheduledTasks),
    //         },
    //       ]
    //     : [];
