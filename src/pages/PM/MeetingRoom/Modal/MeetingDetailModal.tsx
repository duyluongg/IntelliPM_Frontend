...
// const ModalDetailRoom: FC<Props> = ({ meeting, onClose, onDelete }) => {
//   return (
...
//         <p><strong>Phòng họp:</strong> <a href={meeting.roomUrl} className="text-blue-500 underline" target="_blank">{meeting.roomUrl}</a></p>
