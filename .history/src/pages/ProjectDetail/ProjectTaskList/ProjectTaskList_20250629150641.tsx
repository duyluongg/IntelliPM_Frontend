...
import taskIcon from '../../../assets/icons/type_task.svg'; 
import subtaskIcon from '../../../assets/icons/type_subtask.svg'; 
import bugIcon from '../../../assets/icons/type_bug.svg'; 
import epicIcon from '../../../assets/icons/type_epic.svg'; 
import storyIcon from '../../../assets/icons/type_story.svg'; 
            ...
            {tasks.map((task) => (
              <tr key={task.id}>
                <td>
                  ...
                  {task.type === 'story' && <img src={epicIcon} alt="Story" className="icon" />}
                </td>
                <td>
                  <span
