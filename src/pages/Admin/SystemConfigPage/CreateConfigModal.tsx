...
const CreateConfigModal: React.FC<CreateConfigModalProps> = ({ isOpen, onClose }) => {
  const [createConfig] = useCreateMutation();
  const [formData, setFormData] = useState<SystemConfigurationRequest>({
    configKey: '',
    valueConfig: '',
    description: '',
    effectedFrom: '',
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      >
        ...
        <h2 className="text-xl font-semibold mb-4 text-gray-800 pr-8">Create Configuration</h2>
